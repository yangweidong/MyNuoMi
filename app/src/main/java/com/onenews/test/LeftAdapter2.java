 ...
 */
public class LeftAdapter2 extends RecyclerView.Adapter<LeftAdapter2.CityViewHolder> {
    private SparseBooleanArray selectedItems = new SparseBooleanArray();
    private Context mContext;
    private List<FatherItem> mCategoriesEntities;

    public LeftAdapter2(Context context, List<FatherItem> categoriesEntities) {
