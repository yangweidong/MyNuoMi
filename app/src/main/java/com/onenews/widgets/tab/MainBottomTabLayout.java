package com.onenews.widgets.tab;
...
public class MainBottomTabLayout extends LinearLayout {
    ...
    private String mTitles[] = {"主页", "发现", "推荐", "我"};
    private int mIconRes[][] = {
            {R.mipmap.home_normal, R.mipmap.home_selected},
            {R.mipmap.search_normal, R.mipmap.search__selected},
            {R.mipmap.news_normal, R.mipmap.news_selected},
            {R.mipmap.contacts_normal, R.mipmap.contacts_selected}
    };
